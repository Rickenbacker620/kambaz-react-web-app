...
export default function WorkingWithObjects() {
  ...
  return (
    <div id="wd-working-with-objects">
      ...
      <a id="wd-retrieve-modules" className="btn btn-primary" href={`${MODULE_API_URL}`}>
        Get Module
      </a>
      <hr />
      ...
      />
      <hr />
      <h3>Assignments Properties</h3>
      <a id="wd-retrieve-assignment-score" className="btn btn-primary" href={`${ASSIGNMENT_API_URL}/score`}>
      ...
      />
      <hr />
      <a id="wd-retrieve-assignment-completed" className="btn btn-primary" href={`${ASSIGNMENT_API_URL}/completed`}>
      ...
      />
      <hr />
      <a id="wd-retrieve-module-description" className="btn btn-primary" href={`${MODULE_API_URL}/description`}>
